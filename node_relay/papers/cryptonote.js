module.exports = {
   'Introduction': [
      ...
      "In this paper, we study and propose solutions to the main deficiencies of Bitcoin. We believe that a system taking into account the solutions we propose will lead to a healthy competition among different electronic cash systems. We also propose our own electronic cash, \"_PROTOCOL_\", a name emphasizing the next breakthrough in electronic cash.",
   ],
   ...
   'The _PROTOCOL_ Technology': [
      "Now that we have covered the limitations of the Bitcoin technology, we will concentrate on presenting the features of _PROTOCOL_.",
   ],
   ...
   'Smooth emission': [
      "The upper bound for the overall amount of _PROTOCOL_ digital coins is: MSupply = 2^64 - 1 atomic units. This is a natural restriction based only on implementation limits, not on intuition such as \"N coins ought to be enough for anybody\".  To ensure the smoothness of the emission process we use the following formula for block rewards:BaseReward = (MSupply - A) >> 18, where A is amount of previously generated coins.",
   ...
   'Conclusion': [
      "We have investigated the major flaws in Bitcoin and proposed some possible solutions. These ad- vantageous features and our ongoing development make new electronic cash system _PROTOCOL_ a serious rival to Bitcoin, outclassing all its forks.",
      ...
      "We do not consider _PROTOCOL_ as a full replacement to Bitcoin. On the contrary, having two (or more) strong and convenient currencies is better than having just one. Running two and more different projects in parallel is the natural flow of electronic cash economics.",
   ],
   ...
   'References': [
      ...
      "Ronald Cramer, Ivan Damg ̊ard, and Berry Schoenmakers. Proofs of partial knowledge and simplified design of witness hiding protocols. In CRYPTO, pages 174-187, 1994.\n",
